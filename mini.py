...
team2='KKR'
toss_winner='KKR'
input=[dicVal[team1],dicVal[team2],'24',dicVal[toss_winner],'1','7','8']
...
team2='RCB'
toss_winner='RCB'
input=[dicVal[team1],dicVal[team2],'21',dicVal[toss_winner],'1','9','8']
input = np.array(input).reshape((1, -1))
output=model.predict(input)
print(list(dicVal.keys())[list(dicVal.values()).index(output)])
...
team2='DD'
toss_winner='DD'
input=[dicVal[team1],dicVal[team2],'7',dicVal[toss_winner],'0','9','6']
input = np.array(input).reshape((1, -1))
output=model.predict(input)
print(list(dicVal.keys())[list(dicVal.values()).index(output)])
...
team2='MI'
toss_winner='KXIP'
input=[dicVal[team1],dicVal[team2],'19',dicVal[toss_winner],'1','9','8']
input = np.array(input).reshape((1, -1))
output=model.predict(input)
print(list(dicVal.keys())[list(dicVal.values()).index(output)])
...
team2='CSK'
toss_winner='CSK'
input=[dicVal[team1],dicVal[team2],'28',dicVal[toss_winner],'0','9','9']
input = np.array(input).reshape((1, -1))
output=model.predict(input)
print(list(dicVal.keys())[list(dicVal.values()).index(output)])
